    ...
    const fetchEmployees = async () => {
      try {
        ...
        if (Array.isArray(response)) {
          // ✅ Ensure employees have details data
          const processedEmployees = response.map((emp) => ({
            ...emp.employee_details, // flatten details
            _id: emp._id, // keep the main id
          }));
                  ...
                  >
                    {row.getVisibleCells().map((cell) => (
                      <TableCell
                        key={cell.id}
                        onClick={() =>
                          router.push(`/employees/${row.original._id}`)
                        }
                    ...
                    <TableCell>
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          router.push(
                            `/employees/${row.original._id}/employee-documents/create`
                          );
                        }}
                      >
