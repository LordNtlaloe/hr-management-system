...
export default function DocumentsByEmployeeIdTable() {
    ...
    useEffect(() => {
        const fetchDocuments = async () => {
            try {
                setLoading(true)
                const response = await getAllEmployeeDocuments(employeeId)
        ...
        <div className="w-full">
            <div className="flex items-center py-4">
                ...
                <Button
                    variant="default"
                    className="ml-auto"
                    onClick={() => router.push(`/employees/${employeeId}/documents/upload`)}
                >
                    Upload Document
                </Button>
                <DropdownMenu>
