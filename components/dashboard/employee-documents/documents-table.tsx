...
import { getAllDocuments } from "@/actions/employee.documents.actons" // Assuming you'll create this action
...
export default function DocumentsTable() {
    ...
    useEffect(() => {
        const fetchDocuments = async () => {
            try {
                setLoading(true)
                const response = await getAllDocuments() // New action to get all documents
        ...
        <div className="w-full">
            <div className="flex items-center py-4">
                <Input
                    ...
                    onChange={(event) => table.getColumn("national_id")?.setFilterValue(event.target.value)}
                    className="max-w-sm"
                />
                <Button
                    variant="default"
