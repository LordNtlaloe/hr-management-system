    ...
    useEffect(() => {
        ...
        if (searchTerm) {
            filtered = filtered.filter(leave =>
                ...
                leave.employeeId.email.toLowerCase().includes(searchTerm.toLowerCase()) ||
            ...
            <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                        {employeeId ? 'Your leave request history' : 'Manage employee leave requests'}
                    </p>
                </div>
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <div className="flex items-start space-x-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {(leave.employeeId.position || leave.employeeId.department) && (
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex items-center space-x-2 text-sm text-gray-500">
                                                ...
                                                <span>
                                                    Applied on {format(new Date(leave.appliedDate), 'MMM d, yyyy h:mm a')}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-md">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <Avatar className="w-6 h-6">
                                                        <AvatarImage src={(leave.approvedBy || leave.rejectedBy)?.avatar} />
                                                        <AvatarFallback className="text-xs">
                                                            {(leave.approvedBy || leave.rejectedBy)?.name.charAt(0)}
                                                        </AvatarFallback>
                                                    </Avatar>
